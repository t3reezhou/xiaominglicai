...
public class BarChart01View extends DemoView implements Runnable { // DemoView
	...
	private void chartDataSet() {
		...
		// dataSeriesA.add(33d);
		// dataSeriesA.add(50d);
		BarData BarDataA = new BarData("现金存入", dataSeriesA, colorORACLE);

		List<Double> dataSeriesB = new ArrayList<Double>();
		dataSeriesB.add(0.d); // 32
		// dataSeriesB.add(25d);
		// dataSeriesB.add(18d);
		BarData BarDataB = new BarData("现金支出", dataSeriesB, colorMSSQL);

		List<Double> dataSeriesC = new ArrayList<Double>();
		dataSeriesC.add(79d);
		// dataSeriesC.add(91d);
		// dataSeriesC.add(65d);
		BarData BarDataC = new BarData("银行存入", dataSeriesC, colorMYSQL);

		List<Double> dataSeriesD = new ArrayList<Double>();
		dataSeriesD.add(52d);
		// dataSeriesD.add(45d);
		// dataSeriesD.add(35d);
		BarData BarDataD = new BarData("银行取出", dataSeriesD, colorOTHER);
	...
	private void drawLast() {
		 ...
		 * an4.setBgColor(Color.rgb(255, 145, 126)); an4.setAnchor("我是批注");
		 * 
		...
		/*
		 * CustomLineData line1 = new CustomLineData("分界",60d,Color.rgb(218,
	...
	private void drawDyLegend() {
		 ...
		 * pDyLegend4.setColor(Color.YELLOW); dyLegend.addLegend("总计:xxx(PB)",
		 * pDyLegend4);
		 */
	...
	private void triggerClick(float x, float y) {
		...
		if (!chart.getListenItemClickStatus()) {
			...
			chart.getToolTip().addToolTip(mDotToolTip, bData.getKey(),
					mPaintToolTip);
			chart.getToolTip().addToolTip("数量:" + Double.toString(bValue),
					mPaintToolTip);
	...
	/*
	 * private void chartPieDataSet() { //演示用，不精准计算，生产环境应使用MathHelper相关类来时行计算
	 * //随便弄的 chartDataPie.clear(); chartDataPie.add(new PieData("ORACLE","27%"
	 * , 27,colorORACLE)); chartDataPie.add(new PieData("SQL Server","8%"
	 * ,8,colorMSSQL)); chartDataPie.add(new PieData("MySQL","42%"
	 * ,42,colorMYSQL)); chartDataPie.add(new PieData("其它","23%"
	 * ,23,colorOTHER)); }
	 */
	public void setPercentage(int[] per) {
		...
		// dataSeriesA.add(33d);
		// dataSeriesA.add(50d);
		BarData BarDataA = new BarData("现金收入", dataSeriesA, colorORACLE);
